...
const MainStartingNewBusiness = () => {
  ...
  return (
    <div
      className={`${componentName}_MAIN_CONTAINER relative top-[-20px] max-w-[80%] mx-auto bg-[var(--main-color)] text-sky-950/90 p-4 text-center rounded-md`}
    >
      ...
      <Link
        ...
        className='border-2 p-2 px-4 border-sky-950/90 hover:bg-sky-950/90 hover:text-white duration-[var(--main-duration)] rounded-md'
      >
        Business Services
      </Link>
    </div>
